...
<div class="card card-custom bg-gray-100 card-stretch gutter-b">
    ...
    <div class="card-header border-0 bg-danger py-5">
        <h3 class="card-title font-weight-bolder text-white">School Dashboard</h3>
...
</svg><!--end::Svg Icon--></span>                    <a href="{{url('/listcourses')}}" class="text-warning font-weight-bold font-size-h6">
                       Courses
                    </a>
                    {{-- <span>{{$courses}}</span> --}}
                </div>
...
</svg><!--end::Svg Icon--></span>                    <a href="{{url('/listgallery')}}" class="text-primary font-weight-bold font-size-h6 mt-2">
                        Galleries
...
</svg><!--end::Svg Icon--></span>  <a href="{{url('/sliders')}}" class="text-danger font-weight-bold font-size-h6 mt-2">
                        {{-- Sliders {{$sliders}} --}}
                        Sliders
                    </a>
                </div>
...
</svg><!--end::Svg Icon--></span>                    <a href="{{url('/events')}}" class="text-success font-weight-bold font-size-h6 mt-2">
    Events
                        {{-- Events {{$events}} --}}
                    </a>
                </div>
...
<!--end::List Widget 1-->
	...
	<div class="col-xxl-12 ml-3 order-2 order-xxl-1">
		<!--begin::Advance Table Widget 2-->
<div class="card card-custom card-stretch gutter-b">
    <!--begin::Header-->
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label font-weight-bolder text-dark">New Message</span>
        </h3>
