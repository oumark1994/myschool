...
<div class="d-flex flex-column flex-row-fluid wrapper mt-10" id="kt_wrapper">
    ...
    <div class="card card-custom gutter-b example example-compact">
        ...
        @endif
        <!--begin::Form-->
        <form class="form" method="POST" action="{{url('/addevent')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="card-body">
     
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control form-control-solid" name="title" placeholder="Enter event title"/>
                </div>
            ...
            <div class="card-footer">
                ...
                <a type="reset" href="{{url('/listevents')}}" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    <!--end::Card-->
</div>
